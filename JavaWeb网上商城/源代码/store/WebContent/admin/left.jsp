...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('0104','01','商品管理');
		d.add('010401','0104','已上架商品列表','${pageContext.request.contextPath}/adminProduct?method=findByPage','','mainFrame');
		d.add('010402','0104','新增商品','${pageContext.request.contextPath}/adminProduct?method=addUI','','mainFrame');
		d.add('0105','01','订单管理');
